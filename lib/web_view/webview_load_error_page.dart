...
class WebViewLoadErrorPage extends StatefulWidget {
  final Flourish flourish;

  WebViewLoadErrorPage({
    super.key,
    required this.flourish,
  });

  @override
  WebViewLoadErrorPageState createState() => WebViewLoadErrorPageState();
}

class WebViewLoadErrorPageState extends State<WebViewLoadErrorPage> {
  String get title {
